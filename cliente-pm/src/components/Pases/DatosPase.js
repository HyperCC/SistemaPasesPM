    ...
    return (
        <div class="bg-white p-4 md:p-8 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-7 gap-6 md:grid-cols-6 mt-6 mx-8 mb-2 md:mb-0">
                ...
                {/* filtrado de area en pases que no lo requieran */}
                    ...
                    <div class="col-span-1 col-start-2 row-start-1 md:col-span-1">
                        <p>
                            <div class="relative inline-flex">
                                ...
                                <select name="Area" value={props._dataPaseGeneral.Area} onChange={data => cambiarValoresInput(data)} class="border border-gray-300 rounded-full text-gray-600 h-10 pl-5 pr-10 bg-gray-100 hover:border-gray-400 focus:outline-none appearance-none">
