                                ...
                                props.datos.length > 0 ?
                                    ...
                                    props.datos.slice(offset, offset + postsPerPage).map((valor, index) => {
                                        ...
                                        return <tr key={index} class={index % 2 == 0 ? "text-center border-b border-gray-200 text-sm text-gray-800 whitespace-nowrap"
                                            ...
                                            <td class="p-4">
                                                <select onChange={asignarNuevoRol} name="RolActualizar" class="bg-gray-200 p-2 rounded-md text-center">
                                                    <option selected={currentRol == 'SOLICITANTE' ? 'selected' : ''} value="SOLICITANTE">Solicitante</option>
                                                    <option selected={currentRol == 'GUARDIA' ? 'selected' : ''} value="GUARDIA">Guardia</option>
