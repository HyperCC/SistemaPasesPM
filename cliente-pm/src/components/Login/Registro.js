                        ...
                        <form>
                            ...
                            <div class="grid grid-cols-3 px-4 md:px-8 gap-4 mt-12">
                                ...
                                <div class="col-span-2">
                                    <input type="text" value={dataUsuario.Rut} onChange={ingresarValoresMemoria} name="Rut" 
                                    class="w-full border py-1 px-3 border-gray-300 outline-none rounded-md bg-gray-100" autoFocus />
                                </div>
                                ...
                                <div class="col-span-2">
                                    <input type="text" name="Nombres" value={dataUsuario.Nombres} onChange={ingresarValoresMemoria} 
                                    class="w-full border py-1 px-3 border-gray-300 outline-none rounded-md bg-gray-100" />
                                </div>
                                ...
                                <div class="col-span-2">
                                    <input type="text" value={dataUsuario.Apellidos} onChange={ingresarValoresMemoria} name="Apellidos" 
                                    class="w-full border py-1 px-3 border-gray-300 outline-none rounded-md bg-gray-100" />
                                </div>
                                ...
                                <div class="col-span-2">
                                    <input type="email" value={dataUsuario.Correo} onChange={ingresarValoresMemoria} name="Correo" 
                                    class="w-full border py-1 px-3 border-gray-300 outline-none rounded-md  bg-gray-100" />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-3 px-4 md:px-8 gap-4 mt-6">
                                ...
                                <div class="col-span-2">
                                    <input type="text" value={dataUsuario.RutEmpresa} onChange={ingresarValoresMemoria} name="RutEmpresa" 
                                    class="w-full border  py-1 px-3 border-gray-300 outline-none rounded-md bg-gray-100" />
                                </div>
                                ...
                                <div class="col-span-2">
                                    <input type="text" value={dataUsuario.NombreEmpresa} onChange={ingresarValoresMemoria} name="NombreEmpresa" 
                                    class="w-full border py-1 px-3 border-gray-300 outline-none rounded-md bg-gray-100" />
                                </div>
                            </div>
                            ...
                            <div class="mt-12 flex justify-center">
                                <button type="submit" onClick={botonRegistrarUsuario}
                                    class="bg-verde-pm mr-2 hover:bg-amarillo-pm focus:outline-none shadow-md font-semibold px-5 py-2 select-none text-white rounded-md transition duration-500">
                                    Guardar
                                </button>

                                <a href="/"
                                    class="bg-verde-pm ml-2 hover:bg-amarillo-pm focus:outline-none shadow-md font-semibold px-5 py-2 select-none text-white rounded-md transition duration-500">
                                    Volver
                                </a>
                            </div>
                        </form>
