                    ...
                    <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                        ...
                        <form class="flex flex-col pt-3 md:pt-8">
                            <div class="flex flex-col pt-4">
                                ...
                                <input type="email" name="Email" value={dataUsuario.Email} onChange={ingresarValoresMemoria} placeholder="your@email.com" autoFocus 
                                class="shadow-sm border border-gray-300 rounded w-full py-2 px-3 text-gray-800 mt-1 leading-tight outline-none" />
                            </div>

                            <div class="flex flex-col pt-4">
                                <label for="Password" class="text-lg">Contraseña</label>
                                <div class="relative">
                                    <input type={hidePassword ? "text" : "password"} autoComplete="off" name="Password" value={dataUsuario.Password} onChange={ingresarValoresMemoria} placeholder="Contraseña" 
                                    class="shadow-sm border border-gray-300 rounded w-full py-2 px-3 text-gray-800 mt-1 leading-tight outline-none" />

                                    <div class="absolute inset-y-0 right-0 top-1 pr-3 flex items-center leading-5" onClick={cambiarHidePassword}>
