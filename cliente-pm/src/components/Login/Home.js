        ...
        <div>
            <div class="w-full flex flex-wrap">
                <div class="w-full md:w-1/2 flex flex-col">
                    ...
                    <LanzarNoritificaciones codigo={window.localStorage.getItem('mensaje_success') == null ? 'none' : window.localStorage.getItem('mensaje_success')} />
                    ...
                    <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                        ...
                        <form class="flex flex-col pt-3 md:pt-8" onsubmit="event.preventDefault();">
                            ...
                            <input type="submit" value="Entrar" class="bg-azul-pm rounded-lg shadow-md hover:bg-amarillo-pm text-white font-bold text-lg  p-2 mt-8 transition duration-500"></input>
                        </form>
